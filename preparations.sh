...
. .venv/bin/activate
python -c 'import sys; print(sys.prefix); print(sys.base_prefix); print("False means we are in the venv :)"); print(sys.base_prefix == sys.prefix)'
...
python DisCo/download_stable_diffusion.py
